...
import { Mail, Lock, LogIn, ShieldCheck, AlertCircle, ArrowRight } from 'lucide-react';
    ...
    <div className="min-h-screen flex items-center justify-center bg-zinc-50 p-4">
      <div className="w-full max-w-[400px]">
        ...
        <div className="flex flex-col items-center mb-8 text-center">
          ...
          <h1 className="text-2xl font-semibold tracking-tight text-zinc-900">Bienvenido</h1>
          <p className="text-sm text-zinc-500 mt-2">Ingresa tus credenciales para acceder</p>
        </div>
        ...
        <p className="mt-8 text-center text-sm text-zinc-500">
          ...
          <Link href="/register" className="font-medium text-zinc-900 hover:underline inline-flex items-center gap-1">
